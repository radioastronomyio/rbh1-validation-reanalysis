...
related_documents:
  ...
  - "[Visualization Script](../07-validation-visualizations.py)"
---
-->
...
Plots are generated by `07-validation-visualizations.py`:
...
```bash
python 07-validation-visualizations.py --outdir ./plots --standalone --format pdf
```
